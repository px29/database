...
public class BuildPrefixExpressionTreeVisitorTest {
	...
	public void testMultiplicationNode() {
		...
		TreeNode n2 = new LeafTreeNode(2.0);
		TreeNode n3 = new MultiplicationTreeNode(n5, n2);
		TreeNode n4 = new MultiplicationTreeNode(n2, n5);
	...
	public void testDivisionNode() {
		...
		TreeNode n5 = new UnaryMinusTreeNode(n1);
		TreeNode n2 = new LeafTreeNode(2.0);
		TreeNode n3 = new DivisionTreeNode(n5, n2);
		TreeNode n4 = new DivisionTreeNode(n2, n5);
